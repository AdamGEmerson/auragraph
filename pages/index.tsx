...
import {IconBrandSpotify, IconCirclesRelation, IconLogin} from "@tabler/icons";
        ...
        <Center style={{height: 600}}>
            <Stack>
                <Card
                    ...
                    withBorder>
                    <Title order={1} color={theme.fn.rgba(theme.colors.teal[7], .8)} sx={{fontSize: "100px"}}>auragraph</Title>
                ...
                <Grid px={'md'}>
                    <Grid.Col span={12}><Title order={3}>Request access below, and in the mean time, check out our demo.</Title></Grid.Col>
                    <Grid.Col span={8}><TextInput size={'xl'} placeholder={'email'} radius={'lg'}></TextInput></Grid.Col>
                    <Grid.Col span="auto"><Button color={'teal'} size={'xl'} radius={'lg'}>Request Access</Button></Grid.Col>
                </Grid>
